...
function searchMatrix5(matrix: number[][], target: number): boolean {
  const m = matrix.length;
  const n = matrix[0].length;
  ...
  while (l <= r) {
    ...
    const num = matrix[Math.floor(m / n)][m % n];
    if (num === target) {
      return true;
    } else if (num > target) {
      r = m - 1;
...
function searchMatrix6(matrix: number[][], target: number): boolean {
  const m = matrix.length;
  const n = matrix[0].length;
  let l = 0;
  let r = m * n - 1;
  while (l <= r) {
    const mid = Math.floor((r - l) / 2) + l;
    console.log('mid:', l, r, mid, Math.floor(mid / n), mid % m);
...
function searchMatrix7(matrix: number[][], target: number): boolean {
  const m = matrix.length;
  const n = matrix[0].length;
...
// console.log(searchMatrix6([[1, 3, 5, 7], [10, 11, 16, 20], [23, 30, 34, 60]], 3)) // true


// console.log(searchMatrix6([[1, 3, 5, 7], [10, 11, 16, 20], [23, 30, 34, 60]], 13)) // false


// console.log(searchMatrix6([[1, 3, 5, 7], [10, 11, 16, 20], [23, 30, 34, 60]], 1)) // true

// console.log(searchMatrix6([[1]], 2)) // false

// console.log(searchMatrix6([[1, 1]], 2)) // false

console.log(searchMatrix6([[1, 3]], 3)) // false